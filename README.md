...
Foundry VTT stores compendium folder assignments in the `core.compendiumFolder`
...
This module automates that recover process for module and system compendiums.
